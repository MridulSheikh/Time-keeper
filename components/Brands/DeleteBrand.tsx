...
export const DeleteBrand = ({ id, name}: {id : string , name : string}) => {
  ...
  return (
    <div>
      <ConfirmModal isOpen={isOpen} setIsOpen={setIsOpen} condition={name} action={deletFolderHandaler} message={`Are you sure want to delete this Brand. Please type '${name}' `} loading={isLoading} />
